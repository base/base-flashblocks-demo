...
export function SubBlockCard({ blockId, subBlock, isPending }: SubBlockCardProps) {
    return (
        <Card
            ...
            <div className="p-3">
                ...
                <div className="space-y-1">
                    {subBlock.transactions.map((tx, index) => (
                        <div key={index} className="flex justify-between items-center text-xs text-gray-400">
